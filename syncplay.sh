...
if pct status "$CTID" >/dev/null 2>&1; then
  ...
  echo "Run this first if you want to rebuild:"
  echo "pct stop $CTID || true && pct destroy $CTID"
  exit 1
fi
...
echo "== Install Fladder inside LXC =="
...
echo "== Clone Fladder-Maktep syncplay branch =="
...
echo "== Patch common RepeatMode issue if present =="
python3 <<'PY'
...
echo "== Fladder installed successfully =="
LXC_SCRIPT
